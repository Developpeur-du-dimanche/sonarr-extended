...
namespace NzbDrone.Core.Notifications.Xbmc
{
    ...
    public class XbmcJsonApiProxy : IXbmcJsonApiProxy
    {
        ...
        {
            ProcessRequest(settings, "GUI.ShowNotification", title, message, "https://raw.githubusercontent.com/Developpeur-du-dimanche/sonarr-extended/v5-develop/Logo/64.png", settings.DisplayTime * 1000);
        }
