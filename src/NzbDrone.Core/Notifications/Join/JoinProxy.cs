    ...
    public class JoinProxy : IJoinProxy
    {
        ...
        private void SendNotification(string title, string message, HttpMethod method, JoinSettings settings)
        {
            ...
            var request = requestBuilder.AddQueryParam("apikey", settings.ApiKey)
                          ...
                          .AddQueryParam("icon", "https://raw.githubusercontent.com/Developpeur-du-dimanche/sonarr-extended/v5-develop/Logo/256.png") // Use the Sonarr Extended logo.
                          .AddQueryParam("smallicon", "https://raw.githubusercontent.com/Developpeur-du-dimanche/sonarr-extended/v5-develop/Logo/96-Outline-White.png") // 96x96px with outline at 88x88px on a transparent background.
